...
public class Fila {
    ...
    public void abrirFila() {
        System.out.println("La fila está abierta en este momento.");
    }
    public void personaLlega(String nombre) {
    ...
    public void atenderVariasPersonas(int cantidad) {
        if (cantidad <= contador) {
            for (int i = 0; i < cantidad; i++) {
                atenderPersona();
            }
        } else {
            System.out.println("No hay suficientes personas en la fila para atender.");
        }
    }
