...
class Hamburguesa {
    ...
    public void mostrar() {
        System.out.println("HashCode de la carne: " + System.identityHashCode(carne));
        System.out.println("HashCode de el pan: " + System.identityHashCode(panes[0]));
        System.out.println("HashCode de el pan: " + System.identityHashCode(panes[1]));
