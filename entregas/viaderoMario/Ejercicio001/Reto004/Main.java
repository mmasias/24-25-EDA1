...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      Cancion cancion2 = new Cancion("Los Dinosaurios", "Charly García ", 234);
      ...
      switch (opcion) {
        case 1:
          ...
          System.out.println(
            "11. Agregar cancion en reproduccion a una nueva playlist"
          );
          System.out.println(
            "12. Añadir cancion en reporduccion a una playlist existente"
          );
          ...
          switch (opcionReproduccion) {
            ...
            case 9:
              ...
              biblioteca.verAlbums();
              System.out.println(
                "Ingrese el título de la canción o ingrese 1 si quiere añadir la que se esta reproduciendo actualmente:"
              );
            ...
            case 10:
              ...
              Cancion cancionEliminar = biblioteca.buscarCancion(
                tituloEliminar,
                reproductor.cola
              );
            ...
            case 12:
              ...
              Playlist playlistExistente = biblioteca.buscaPlaylist(
                nombrePlaylistExistente
              );
        ...
        case 2:
          ...
          switch (opcionBiblioteca) {
            ...
            case 2:
              ...
              System.out.println(
                "1. Añadir cancion favorita a cola de reproducción"
              );
              ...
              switch (opcionFavoritas) {
                case 1:
                  ...
                  biblioteca.verCancionesFavoritas();
                  System.out.println(
                    "Ingrese el título de la canción a añadir:"
                  );
                  String tituloFavorita = scanner.next();
                  Cancion cancionFavorita = biblioteca.buscarCancion(
                    tituloFavorita,
                    biblioteca.cancionesFavoritas
                  );
                ...
                case 2:
                  ...
                  biblioteca.verCancionesFavoritas();
                  System.out.println(
                    "Ingrese el título de la canción a eliminar:"
                  );
                  String tituloEliminar = scanner.next();
                  Cancion cancionEliminar = biblioteca.buscarCancion(
                    tituloEliminar,
            ...
            case 3:
              ...
              switch (opcionPlaylist) {
                case 1:
                  ...
                  biblioteca.verPlaylist();
                  System.out.println(
                    "Ingrese el nombre de la playlist a reproducir:"
                  );
                  String nombrePlaylist = scanner.next();
                ...
                case 2:
                  ...
                  Playlist playlistEliminar = biblioteca.buscaPlaylist(
                    nombrePlaylistEliminar
                  );
                ...
                case 4:
                  ...
                  Playlist playlistuso = biblioteca.buscaPlaylist(
                    nombrePlaylistusar
                  );
                  if (playlistuso != null) {
                ...
                case 5:
                  ...
                  Playlist playlistver = biblioteca.buscaPlaylist(
                    nombrePlaylistver
                  );
                  if (playlistver != null) {
