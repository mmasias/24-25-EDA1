...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        biblioteca.iniciarpredeterminados();
            ...
            switch (opcion) {
                case 1:
                    ...
                    switch (opcionReproduccion) {
                        ...
                        case 7:
                            reproductor.activarModoRepetir(!reproductor.modoRepetir);
                        ...
                        case 9:
                            ...
                            if (tituloFavorita.equals("1")) {
                                ...
                                if (cancionActual != null) {
                                    cancionActual.setFavorita(true);
                        ...
                        case 10:
                            ...
                            Cancion cancionEliminar = biblioteca.buscarCancion(tituloEliminar, reproductor.colaReproduccion);
                        ...
                        case 11:
                            ...
                            playlist.agregarCancion(reproductor.getCancionActual());
                        ...
                        case 12:
                            ...
                            if (playlistExistente != null) {
                                playlistExistente.agregarCancion(reproductor.getCancionActual());
                            } else {
                        ...
                        case 2:
                            ...
                            switch (opcionFavoritas) {
                                ...
                                case 2:
                                    ...
                                    if (cancionEliminar != null) {
                                        cancionEliminar.setFavorita(false);
                                        biblioteca.eliminarCancionFavorita(cancionEliminar);
                                    } else {
                                        System.out.println("Canción no encontrada.");
                                    }
                            ...
                            switch (opcionPlaylist) {
                                ...
                                case 3:
                                    ...
                                    if (playlistExistente != null) {
                                        ...
                                        int duracion = scanner.nextInt();
                                        Cancion cancion = new Cancion(titulo, artista, duracion);
                                        playlistExistente.agregarCancion(cancion);
                                    } else {
                                        System.out.println("Playlist no encontrada.");
                                    }
                                case 4:
