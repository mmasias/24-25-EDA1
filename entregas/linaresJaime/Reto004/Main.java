...
public class Main {
    public static void main(String[] args) {
        ...
        Cancion cancion = new Cancion("Fashion killa", "A$AP Rocky", 296);
        Cancion cancion2 = new Cancion("Homecoming", "Kanye West", 203);
        Cancion cancion3 = new Cancion("Nights like this", "The Kid Laroi",86 );
        Cancion cancion4 = new Cancion("Nueva Era", "Duki", 217);
        Cancion cancion5 = new Cancion("Beso", "Wakyin",197);
        biblioteca.crearPlaylist("Lini");
        ...
        biblioteca.anadirCancionAPlaylist(0, cancion5);
